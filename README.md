...
Proc report different titles headers footnotes and number of obs per page
    ...
    ```                                                                                                                                                               ```
    ```  see                                                                                                                                                          ```
    ```  https://communities.sas.com/t5/ODS-and-Base-Reporting/Proc-report/m-p/415225                                                                                 ```
    ```                                                                                                                                                               ```
    ...
    ```  ====                                                                                                                                                         ```
    ```                                                                                                                                                               ```
    ```   (note different title, footnote and column labels)                                                                                                          ```
    ```                                                                                                                                                               ```
    ```                                                                                                                                                               ```
    ```   +---------------------------------------------------------------------------------------------------------------------------+                               ```
    ```   |                                                                                                               Page 1 of 6 |                               ```
    ...
    ```            run;quit;                                                                                                                                          ```
    ```            ods rtf text="^S={outputwidth=100% just=l font_size=8pt font_style=italic}  {from www.&country..com Statistics}";                                  ```
